...
public class LogManager {
	...
	public static String LOGGER_NAME = null;

	private static synchronized Logger getLogger() {
		if (LOGGER_NAME == null) {
			throw new RuntimeException("need a logger name config in web.xml(loggerName) or set to LogManager.LOGGER_NAME before use");
		}
		if (logger == null) {
